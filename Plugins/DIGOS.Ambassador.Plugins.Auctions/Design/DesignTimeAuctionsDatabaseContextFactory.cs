//
//  DesignTimeAuctionsDatabaseContextFactory.cs
//
//  Author:
...
namespace DIGOS.Ambassador.Plugins.Auctions.Design;

/// <summary>
/// Design-time factory for <see cref="CoreDatabaseContext"/> instances.
/// </summary>
[UsedImplicitly]
public class DesignTimeAuctionsDatabaseContextFactory : IDesignTimeDbContextFactory<AuctionsDatabaseContext>
{
    /// <inheritdoc />
    public AuctionsDatabaseContext CreateDbContext(string[] args)
    {
        var configuration = new ConfigurationBuilder()
            .AddAmbassadorConfigurationFiles()
            .Build();

        var optionsBuilder = new DbContextOptionsBuilder<AuctionsDatabaseContext>();
        new ContextConfigurationService(new ContentService(FileSystemFactory.CreateContentFileSystem()), configuration)
            .ConfigureSchemaAwareContext<AuctionsDatabaseContext>(optionsBuilder);

        return new AuctionsDatabaseContext(optionsBuilder.Options);
    }
}
