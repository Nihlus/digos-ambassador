//
//  AutoroleCommands.AutoroleConditionCommands.MessageCountInGuildConditionCommands.cs
//
//  Author:
    ...
    public partial class AutoroleCommands
    {
        public partial class AutoroleConditionCommands
        {
            ...
            public class MessageCountInGuildConditionCommands : ModuleBase
            {
                ...
                public MessageCountInGuildConditionCommands(AutoroleService autoroles, UserFeedbackService feedback)
                {
                ...
                public async Task AddConditionAsync(AutoroleConfiguration autorole, long count)
                {
